...
class SegmentWithPoints:
    def __init__(self, segment: Segment, points: List[Vector] = None, tol: float = 1e-8):
    ...
    def _is_point_on_segment(self, point: Vector) -> bool:
        """
    ...
    def add_point(self, point: Vector) -> None:
        """
        Adds a point
        """
        self.points.append(point)

    def add_point_if_is_in_segment(self, point: Vector) -> None:
        """
    ...
    def get_all_points(self) -> List[Vector]:
        """
    ...
    def __repr__(self) -> str:
        ...
        return f"SegmentWithPoints(segment={self.segment}, points=[{pts_str}])"
